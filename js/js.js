...
$(function () {
    ...
    function echarts_2() {
        ...
        var data = [1558300, 1331600, 1288300, 1101000, 1100100, 1009000, 978800, 918100, 810300, 739700, 729100, 723100, 721400]
        var titlename = ['广州', '郑州', '武汉', '成都', '重庆', '北京', '西安', '南京', '长沙', '上海', '南昌', '哈尔滨', '合肥'];
        option = {
            grid: {
                left: '0',
                top: '0',
            ...
            series: [
                {
                    ...
                    data: [9, 9, 9, 9, 9, 12, 12, 12, 6, 8, 3, 0, 9, 0]
            ...
            series: [
                {
                    ...
                    roseType: 'area',
                    data: [
                        { value: 300, name: '新高考Ⅰ卷' },
                        { value: 170, name: '新高考Ⅱ卷' },
                        { value: 210, name: '全国甲卷' },
                        { value: 600, name: '全国乙卷' },
